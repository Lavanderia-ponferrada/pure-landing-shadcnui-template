      ...
      <div className="dark:border relative overflow-hidden my-20 w-full dark bg-background text-foreground max-w-screen-lg mx-auto rounded-2xl py-10 md:py-16 px-6 md:px-14">
        ...
        <div className="relative z-0 flex flex-col gap-3">
          ...
          <p className="mt-2 text-base md:text-lg">
            Únete a miles de usuarios que ya ahorran dinero comparando precios históricos. 
            Empieza gratis y descubre las mejores ofertas.
          </p>
        </div>
        <div className="relative z-0 mt-14 flex flex-col sm:flex-row gap-4">
          <Button size="lg">
            Empezar Gratis <ArrowUpRight className="!h-5 !w-5" />
          </Button>
          <Button size="lg" variant="outline">
            Ver Planes <Forward className="!h-5 !w-5" />
          </Button>
        </div>
      </div>
    </div>
